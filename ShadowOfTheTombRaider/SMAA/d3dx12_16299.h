    ...
    _In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
    ...
    UINT64 Result = UpdateSubresources(pcommandList, pDestinationResource, pIntermediate, FirstSubresource, NumSubresources, RequiredSize, pLayouts, pNumRows, pRowSizesInBytes, pSrcData);
    ...
    _In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA* pSrcData)
{
    ...
    return UpdateSubresources(pcommandList, pDestinationResource, pIntermediate, FirstSubresource, NumSubresources, RequiredSize, Layouts, NumRows, RowSizesInBytes, pSrcData);
}
...
#if defined(_M_IX86)
class __declspec(align(4)) CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT
#elif defined(_M_X64)
class __declspec(align(8)) CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT
#else
...
inline HRESULT D3DX12ParsePipelineStream(const D3D12_PIPELINE_STATE_STREAM_DESC& Desc, ID3DX12PipelineParserCallbacks* pCallbacks)
{
    ...
    for (SIZE_T CurOffset = 0, SizeOfSubobject = 0; CurOffset < Desc.SizeInBytes; CurOffset += SizeOfSubobject) {
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL1:
            ...
            SizeOfSubobject = sizeof(decltype(CD3DX12_PIPELINE_STATE_STREAM::DepthStencilState));
            break;
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_INPUT_LAYOUT:
            pCallbacks->InputLayoutCb(*reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::InputLayout)*>(pStream));
            SizeOfSubobject = sizeof(decltype(CD3DX12_PIPELINE_STATE_STREAM::InputLayout));
            break;
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_IB_STRIP_CUT_VALUE:
            pCallbacks->IBStripCutValueCb(*reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM::IBStripCutValue)*>(pStream));
            SizeOfSubobject = sizeof(decltype(CD3DX12_PIPELINE_STATE_STREAM::IBStripCutValue));
            break;
        ...
        case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VIEW_INSTANCING:
            ...
            SizeOfSubobject = sizeof(decltype(CD3DX12_PIPELINE_STATE_STREAM1::ViewInstancingDesc));
            break;
        default:
            pCallbacks->ErrorUnknownSubobject(SubobjectType);
            return E_INVALIDARG;
